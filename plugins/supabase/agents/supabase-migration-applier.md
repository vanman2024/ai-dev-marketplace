...
description: Database migration management via MCP - versioning, safe schema changes, rollbacks, and migration history tracking
model: haiku
color: orange
---
...
2. **Use mcp\_\_plugin_supabase_supabase** to apply migrations to the database
