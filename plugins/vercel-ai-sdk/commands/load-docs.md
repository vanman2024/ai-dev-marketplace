---
description: Load Vercel AI SDK documentation on-demand with intelligent link extraction and parallel WebFetch
argument-hint: [feature-name|core|all]
allowed-tools: Task, Read, Bash
---

# Load Vercel AI SDK Documentation

**Purpose:** Load fresh Vercel AI SDK documentation on-demand by extracting external links from local docs and fetching them in priority-based batches.

## Command Arguments

**Syntax:** `/vercel-ai-sdk:load-docs [argument]`
...
/vercel-ai-sdk:load-docs

# Load core documentation explicitly
/vercel-ai-sdk:load-docs core

# Load all documentation (comprehensive)
/vercel-ai-sdk:load-docs all

# Load documentation for specific feature
/vercel-ai-sdk:load-docs streaming
/vercel-ai-sdk:load-docs tools
/vercel-ai-sdk:load-docs providers
```
...
```markdown
Task(
  description="Load Vercel AI SDK documentation",
  subagent_type="doc-loader-agent",
  prompt="Load documentation for Vercel AI SDK with the following parameters:

  **Plugin Information:**
  - Plugin Name: Vercel AI SDK
  - Documentation Path: plugins/vercel-ai-sdk/docs/
  - Loading Scope: $SCOPE

  **Instructions:**
  1. Find all markdown documentation files in plugins/vercel-ai-sdk/docs/
...
```markdown
## Vercel AI SDK Documentation Loaded
...
- `/vercel-ai-sdk:load-docs core` - Essentials only
- `/vercel-ai-sdk:load-docs all` - Everything
- `/vercel-ai-sdk:load-docs {feature}` - Specific feature

**To build features:**
Use the relevant slash commands:
- `/vercel-ai-sdk:new-app` - Initialize new project
- `/vercel-ai-sdk:add-{feature}` - Add specific features
```

## Configuration

**Plugin Variables (Replace when deploying):**
- `Vercel AI SDK` → Human-readable plugin name
- `vercel-ai-sdk` → Command prefix
- `vercel-ai-sdk` → Plugin directory path

**Documentation Path:**
- Default: `plugins/vercel-ai-sdk/docs/`
...
```
Error: No markdown files found in plugins/vercel-ai-sdk/docs/
...
Refer to files in plugins/vercel-ai-sdk/docs/ directly.
```
...
- Plugin-specific build commands (e.g., `/vercel-ai-sdk:new-app`)
- Plugin-specific feature commands (e.g., `/vercel-ai-sdk:add-{feature}`)
- General documentation tools

**Workflow Pattern:**
1. Load documentation with `/vercel-ai-sdk:load-docs {feature}`
2. Review documentation for implementation approach
3. Build feature with `/vercel-ai-sdk:add-{feature}`
