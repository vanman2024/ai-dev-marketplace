---
description: Load Website Builder documentation on-demand with intelligent link extraction and parallel WebFetch
argument-hint: [feature-name|core|all]
allowed-tools: Task, Read, Bash
---

# Load Website Builder Documentation

**Purpose:** Load fresh Website Builder documentation on-demand by extracting external links from local docs and fetching them in priority-based batches.

## Command Arguments

**Syntax:** `/website-builder:load-docs [argument]`
...
/website-builder:load-docs

# Load core documentation explicitly
/website-builder:load-docs core

# Load all documentation (comprehensive)
/website-builder:load-docs all

# Load documentation for specific feature
/website-builder:load-docs streaming
/website-builder:load-docs tools
/website-builder:load-docs providers
```
...
```markdown
Task(
  description="Load Website Builder documentation",
  subagent_type="doc-loader-agent",
  prompt="Load documentation for Website Builder with the following parameters:

  **Plugin Information:**
  - Plugin Name: Website Builder
  - Documentation Path: plugins/website-builder/docs/
  - Loading Scope: $SCOPE

  **Instructions:**
  1. Find all markdown documentation files in plugins/website-builder/docs/
...
```markdown
## Website Builder Documentation Loaded
...
- `/website-builder:load-docs core` - Essentials only
- `/website-builder:load-docs all` - Everything
- `/website-builder:load-docs {feature}` - Specific feature

**To build features:**
Use the relevant slash commands:
- `/website-builder:new-app` - Initialize new project
- `/website-builder:add-{feature}` - Add specific features
```
...
**Documentation Path:**
- Default: `plugins/website-builder/docs/`
...
```
Error: No markdown files found in plugins/website-builder/docs/
...
Refer to files in plugins/website-builder/docs/ directly.
```
...
- Plugin-specific build commands (e.g., `/website-builder:new-app`)
- Plugin-specific feature commands (e.g., `/website-builder:add-{feature}`)
- General documentation tools

**Workflow Pattern:**
1. Load documentation with `/website-builder:load-docs {feature}`
2. Review documentation for implementation approach
3. Build feature with `/website-builder:add-{feature}`
