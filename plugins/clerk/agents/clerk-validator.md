...
description: Validate Clerk environment setup, check configuration, audit security, test auth flows
model: haiku
color: yellow
---
...
- Validate CLERK*PUBLISHABLE_KEY format (starts with pk*)
- Validate CLERK*SECRET_KEY format (starts with sk*)
...
- Grep for hardcoded API keys (sk*, pk* patterns)
