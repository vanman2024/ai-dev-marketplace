...
model: haiku
description: Google File Search API for fully managed RAG with Gemini - handles store creation, file uploads, chunking config, metadata filtering, and grounding citations
color: blue
---
